          ...
          <div className="p-10 bg-gray-800 text-gray-200">
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                <div className='mb-5'>
                  <h4 className='text-2xl pb-4'>NASA API</h4>
                  <p className='text-gray-500'>
                  Explore the Cosmos <br />
                  unleash the Universe <br />
                  Power Your Applications with NASA's API. <br /><br />
                    <strong>Phone: </strong>+9472 2222 222 <br />
                    <strong>Email: </strong>nasapi@icloud.com <br />
                  </p>
                </div>
                <div className='mb-5'>
                ...
                <h4 className='pb-4'>Our Services</h4>
                  <ul className='text-gray-500'>
                    <li className='pb-4'><i class="fa fa-chevron-right text-purple-700"></i><a href="/nasaphoto" class="hover:text-yellow-500"> APOD</a></li>
                    <li className='pb-4'><i class="fa fa-chevron-right text-purple-700"></i><a href="/rover" class="hover:text-yellow-500"> Mars Rover Photos</a></li>
                    <li className='pb-4'><i class="fa fa-chevron-right text-purple-700"></i><a href="pop" class="hover:text-yellow-500"> EPIC</a></li>
                    <li className='pb-4'><i class="fa fa-chevron-right text-purple-700"></i><a href="pop" class="hover:text-yellow-500"> TLE API</a></li>
                    <li className='pb-4'><i class="fa fa-chevron-right text-purple-700"></i><a href="pop" class="hover:text-yellow-500"> Insight</a></li>
                  </ul>     
                </div>
                <div className='mb-5'>
                  <h4 className='pb-4'>Join Our Community</h4>
                  <p className='text-gray-500 pb-2'>We are providing our services to you for 10+ years. Join Us.</p>
          ...
          <div className='w-full bg-gray-900 text-gray-500 px-10'>
            <div className='max-w-7xl flex flex-col sm:flex-row py-4 mx-auto justify-between items-center'>
              <div className='text-center'>
                <div>
                  Copyright <strong><span>Jayasinghe H.D.D.R</span></strong>. All Rights Reserved
                </div>
                <div>
                  Designed by <a href="https://web.facebook.com/dineth.jayasinghe" className='text-purple-700 hover:text-yellow-400'>An Undergraduate of SLIIT</a>
                </div>
              </div>
